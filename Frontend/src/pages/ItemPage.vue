    ...
    <v-container>
        <v-row>
            ...
            <v-col cols="12" lg="2" md="3" sm="12">
                <Button class="w-100 mt-3" :rounded="false" @click="state.dialog = true" variant="elevated"
                    prepend-icon="mdi-plus">Add New Item</Button>
            </v-col>
        </v-row>
        <v-row>
            <v-col cols="12" md="12">
                <Card v-for="item in 10" :key="item" class="mb-10">
                    <template #title>
                        <v-row>
                            <v-col cols="4" md="2">
                    ...
                    <v-row>
                        <v-col cols="2">
                            <v-menu transition="scale-transition">
                                <template v-slot:activator="{ props }">
                                    <Button color="primary" v-bind="props" width="10" :rounded="false">
                                        #
                                    </Button>
                                </template>
