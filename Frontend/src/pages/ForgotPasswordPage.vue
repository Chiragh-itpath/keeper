                            ...
                            <v-card-text>
                                <v-form ref="form">
                                    <div v-if="state.showResetPwdForm">
                                        ...
                                        <TextFieldPassword label="Enter Password" v-model="state.password" color="primary"
                                            class="mb-2">
                                        </TextFieldPassword>
                                    ...
                                    <div v-else>
                                        <div v-if="!state.showOTPForm">
                                            ...
                                            <div class="text-center text-grey mb-2">Please enter your email to recieve a
                                                verification code.
                                            </div>
                                        ...
                                        <div v-else>
                                            <div class="text-h6 text-grey mb-2">OTP has been send to your email address
                                            </div>
                                            <TextFieldOTP label="Enter OTP"
                                                :error-messages="state.otpError ? state.otpErrorMessage : ''"
                                                placeholder="Enter OTP e.g 435355" v-model="state.otp" color="primary" />
                                            <div class="text-right">
                                                <Button @click="ValidateOTP()" :disabled="state.isDisable"
                                                    class="mb-3">Submit</Button>
                                            </div>
                                        </div>
                                    </div>
                                </v-form>
